...
YANDEX_GPT_CONFIG = {
    "model_uri": "gpt://b1gmpvdiu7blj491i69q/yandexgpt-5.1/latest",
    "temperature": 0.3,
    "max_tokens": 2000,
    "timeout": 60,
}
...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        missing = [key for key in ("telegram_bot_token", "yandex_oauth_token", "yandex_folder_id") if not values[key]]
        if missing:
